...
Good
Needs Improvement
Progress saving and loading using file handling
...
2. Scoring System
Checks answers, calculates score, and tracks correct/wrong attempts.
3. File Handling
Stores and retrieves student progress data.
4. User Interface
Displays menus, welcome screens, progress reports, and final summaries.
5. Main Integration
